    ...
    if (user) {
        return (
            <div className="signin-panel signin-panel--authed">
                ...
                <button
                    type="button"
                    className="btn btn--ghost signin-panel__logout"
    ...
    return (
        <div className="signin-panel signin-panel--guest">
            ...
            <div className="signin-panel__buttons">
                <a className="btn btn--provider btn--google" href={`${AUTH_BASE}/auth/google`}>
                    <GoogleIcon />
                    Sign in with Google
                </a>
                <a className="btn btn--provider btn--github" href={`${AUTH_BASE}/auth/github`}>
                    <GitHubIcon />
                    Sign in with GitHub
                </a>
            </div>
