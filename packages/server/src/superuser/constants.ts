...
export const SUPERUSER_NS = `${NS_ROOT}superuser:`;
export const SUPERUSER_GRAPH = new IRI(`${SUPERUSER_NS}graph`);

// Singleton IRI used as the subject node for the superuser membership set.
export const SUPERUSERS_NODE = new IRI(`${SUPERUSER_NS}members`);
...
export const SuperuserIRI = new IRI(`${SUPERUSER_NS}Superuser`);

// Predicate IRIs
export const superuserUserIRI = new IRI(`${SUPERUSER_NS}user`);
export const superuserGrantedAtIRI = new IRI(`${SUPERUSER_NS}grantedAt`);
